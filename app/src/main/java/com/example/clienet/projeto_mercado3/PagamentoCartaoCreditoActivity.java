...
public class PagamentoCartaoCreditoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CartaoCreditoFragment fragment = CartaoCreditoFragment.newInstance(cliente);
    ...
    public void onBackPressed()
    {
        if (PSCheckout.onBackPressed(this)) { //Controle Lib Button back
            ...
            Intent intent = new Intent(PagamentoCartaoCreditoActivity.this, FormaPagamentoActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                Intent intent = new Intent(PagamentoCartaoCreditoActivity.this, MainActivity.class);
            ...
            case R.id.seus_pedidos:
                ...
                Intent intent_pedidos = new Intent(PagamentoCartaoCreditoActivity.this, PedidosActivity.class);
