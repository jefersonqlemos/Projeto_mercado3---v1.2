...
/**
 * Created by jefer on 27/02/2018.
 */

public class MyAdapter4 extends SimpleAdapter {


    public MyAdapter4(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
