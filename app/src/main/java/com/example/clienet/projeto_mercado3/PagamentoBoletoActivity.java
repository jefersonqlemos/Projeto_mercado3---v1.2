...
public class PagamentoBoletoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoletoFragment fragment = BoletoFragment.newInstance(cliente);
    ...
    public void onBackPressed()
    {
        ...
        if (PSCheckout.onBackPressed(this)) { //Controle Lib Button back
            ...
            Intent intent = new Intent(PagamentoBoletoActivity.this, FormaPagamentoActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                Intent intent = new Intent(PagamentoBoletoActivity.this, CarrinhoActivity.class);
            ...
            case R.id.seus_pedidos:
                ...
                Intent intent_pedidos = new Intent(PagamentoBoletoActivity.this, PedidosActivity.class);
